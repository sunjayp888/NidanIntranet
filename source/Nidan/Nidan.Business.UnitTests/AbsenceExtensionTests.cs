...
namespace HR.Business.UnitTests
{
    ...
    public class AbsenceExtensionTests
    {
        ...
        public static IEnumerable FilterNotAbsenceDaysTestCases
        {
            get
            {
                yield return new TestCaseData(
                    ...
                    .SetName("FilterNotAbsenceDays: returns absenceDays if notAbsenceDays is null");
                ...
                yield return new TestCaseData(
                    ...
                    {
                        new WorkingPatternNotAbsenceDay { Date = DateTime.Today, AM = false, PM = false }
                    },
                    false,
                    new List<AbsenceDay>
                    {
                    ...
                    .SetName("FilterNotAbsenceDays: notAbsenceDays removed from absenceDays");
                ...
                yield return new TestCaseData(
                    ...
                    .SetName("FilterNotAbsenceDays: include notAbsenceDays with validation from absenceDays");
                ...
                yield return new TestCaseData(
                    ...
                    new List<INotAbsenceDay>
                    {
                        new WorkingPatternNotAbsenceDay { Date = DateTime.Today, AM = false, PM = true },
                        new WorkingPatternNotAbsenceDay { Date = DateTime.Today.AddDays(2), AM = true, PM = false },
                    },
                    false,
                    new List<AbsenceDay>
                    {
                        new AbsenceDay { AbsenceId = 1, Date = DateTime.Today, AM = false, PM = true, Duration = 0.5, CanBeBookedAsAbsence = true },
                        new AbsenceDay { AbsenceId = 1, Date = DateTime.Today.AddDays(1), AM = true, PM = true, Duration = 1, CanBeBookedAsAbsence = true },
                        new AbsenceDay { AbsenceId = 1, Date = DateTime.Today.AddDays(2), AM = true, PM = false, Duration = 0.5, CanBeBookedAsAbsence = true },
                    })
                    .SetName("FilterNotAbsenceDays: notAbsenceDays half days from absenceDays");
            }
        }
        ...
        public void FilterNotAbsenceDaysTests(IEnumerable<AbsenceDay> absenceDays, IEnumerable<INotAbsenceDay> notAbsenceDays, bool returnUnbookableDays, IEnumerable<AbsenceDay> expectedAbsenceDays)
        {
            ...
            // Act
            var actualAbsenceDays = absenceDays.FilterNotAbsenceDays(notAbsenceDays, returnUnbookableDays);
