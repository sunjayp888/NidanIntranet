...
namespace HR.Business.UnitTests
{
    ...
    public class WorkingPatternExtensionsTests
    {
        ...
        public static IEnumerable ToWorkingPatternNotAbsenceDays
        {
            get
            {
                ...
                yield return new TestCaseData(
                    ...
                    null, 
                    null, 
                    new List<WorkingPatternNotAbsenceDay> { })
                ...
                yield return new TestCaseData(
                   ...
                   new DateTime(2016, 12, 11),
                   new List<WorkingPatternNotAbsenceDay> {
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 5), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 6), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 7), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 8), AM = false, PM = true }
                   })
                   .SetName("ToWorkingPatternNotAbsenceDays: returns list of WorkingPatternNotAbsenceDay");
                ...
                yield return new TestCaseData(
                  ...
                  new List<WorkingPatternNotAbsenceDay> {
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 5), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 6), AM = true, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 7), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 8), AM = false, PM = true },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 12), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 13), AM = true, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 14), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 15), AM = false, PM = true },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 19), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 20), AM = true, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 21), AM = false, PM = false },
                       new WorkingPatternNotAbsenceDay { Date = new DateTime(2016, 12, 22), AM = false, PM = true }
                  })
        ...
        public void ToWorkingPatternNotAbsenceDaysTest(IEnumerable<WorkingPatternDay> workingPatternDays, DateTime beginDate, DateTime endDate, IEnumerable<WorkingPatternNotAbsenceDay> expectedWorkingPatternNotAbsenceDays)
        {
            // Arrange
